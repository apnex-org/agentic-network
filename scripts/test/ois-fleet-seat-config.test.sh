...
claude_dep_count="$(node -p "Object.keys(require('$REPO/adapters/claude-plugin/package.json').dependencies||{}).length")"
...
eq "Claude consumer artifact has zero runtime dependency edges" "0" "$claude_dep_count"
