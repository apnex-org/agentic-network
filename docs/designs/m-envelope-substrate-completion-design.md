# M-Envelope-Substrate-Completion — Design v1.2

**Status:** v1.2 — Phase 6 preflight measurement corrections folded (thread-658 converged): (c1) live bare-shape writers — "cutover @100%" struck; (c2) dirty-cursor trap — W6 cursor discipline + W1 boot-put slice; downtime MEASURED 47-57s composite (<60s confirmed). Prior: v1.1 thread-657 audit integration + Director idea-318 scope-in + W5 self-trigger fold. **mission-90 ACTIVE (2026-06-10); W1 task-415 issued; Phase 8 open.**
