# Council Agenda — standing input for the inter-stint council

**Status:** living · **Owner:** architect · **Established:** 2026-06-28 (stint-3 retro)
...
## A. Standing review items (every council runs these)

1. **Ledger curation — CALIBRATION + FRICTION.**
   - *Calibration ledger:* retire stale/superseded entries; **PROMOTE high-evidence overdue patterns** (e.g. **#62**, methodology-promotion stuck ~7 weeks); re-class off-target entries; burn down fold-debt (23/79 open at stint-3).
   - *Friction ledger:* close resolved frictions; action/assign open ones; a friction's **recurrence-count** sets its mechanization value-bar (FR-31 recurred).
   - **State (2026-06-28):** the stint-3 retro *harvested* both ledgers (swept as surfaces), *filed* new entries (calibrations #89/#90/#91; FR-32/33/34) and *normalized* off-enum #60/#62 — but did **NOT** run a full curation pass (retire/promote/close). The retro **flagged** it (F8 calibration-governance-hygiene; FR-34 banked-loss-obligation). **→ First full curation is OWED — run it at the next council.**

2. **Stint-report review** (idea-369) — the prior stint's generation mix, tele-coverage gaps, generation:incorporation ratio, banked-vs-staked balance.

3. **Idea-funnel triage** (idea-363) — triage the prior stint's idea cohort (keep-vs-cut, triage tags) + read the backlog-health metric (the incorporation constraint).
