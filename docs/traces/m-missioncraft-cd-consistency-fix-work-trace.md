...
3. **Repo state:** apnex/missioncraft `main` at `ee5d4c5` (slice (i)+(iii) shipped; v1.2.4-prep — version bumped, CHANGELOG written, NOT tagged; **CI matrix GREEN** at `ee5d4c5` (ubuntu+macos 22/24, run `25897870710`)).
