...
export type MessageKind = "notification.actionable" | "notification.informational" | "state.change" | "pending-action.dispatch" | "repo-event";
...
export type Message = ActionableMessage | InformationalMessage | StateChangeMessage | PendingActionMessage | RepoEventMessage;
